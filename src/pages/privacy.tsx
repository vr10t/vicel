...
export default function Privacy() {
  const sendgrid = trpc.useMutation("sendgrid.sendEmail");
  ...
  return (
    <Layout
      title="Vicel's Privacy Policy"
      description="We take your privacy very seriously. Here's everything you need to know while browsing our website."
    >
      {/*
      <Script id="CookieDeclaration" src="https://consent.cookiebot.com/4c1bb22f-3ea3-46ec-9a07-dfea19c36438/cd.js" type="text/javascript" async />
      */}
      {/* <button type='button' onClick={handleSubmit} classNameName='w-full p-2 bg-sky-600 text-xl text-white' >Send</button> */}
          ...
          <div>
            <div className="flex flex-col items-center p-8">
              <article className="prose prose-xl">
                ...
                <p>
                  Your privacy is important to us. It is Vicel Ltd.&apos;s
                  ...
                  <a href="https://vicel.co.uk">vicel.co.uk</a>, and other sites
                  we own and operate.{" "}
                </p>
                <p>
                ...
                <p>This policy is effective as of 8 September 2021. </p>
                <p>Last updated: 8 September 2021 </p>
                ...
                <p>
                  ...
                  users for the purpose of publication on our website or
                  re-publishing on our social media channels. All user-generated
                  content is associated with the account or email address used
                ...
                <p>
                  ...
                  such as an email address when contacting us about a specific
                  enquiry, we may retain this information for the duration of
                  your enquiry remaining open as well as for our own records so
                  we may effectively address similar enquiries in future. If
                  your personal information is no longer required for this
                  purpose, we will delete it or make it anonymous by removing
                ...
                <ul>
                  ...
                  <li>
                    ...
                    maintenance or problem-solving providers, professional
                ...
                <p>
                  ...
                  processors”). We, Vicel Ltd., located at the address provided
                  in our Contact Us section, are a Data Controller with respect
                ...
                <p>
                  ...
                  have already sent. If you have any further enquiries about how
                  to withdraw your consent, please feel free to enquire using
                  the details provided in the Contact Us section of this privacy
                  policy.
                </p>
                ...
                <p>
                  ...
                  we restrict the processing of your personal information if (i)
                  ...
                  personal information solely for the purpose of a legal claim;
                  or (iv) we are in the process of considering your objection in
                ...
                <p>
                  ...
                  account, we will delete your personal information within 1
                ...
                <p>
                  <strong>Withdrawing consent:</strong> You may have the right
                  to withdraw your consent on where we rely on consent to
                  process your personal information. If you withdraw your
                  consent, we may not be able to provide you with access to
                  certain specific functionalities of our website.
                </p>
                <p>
                  <strong>Access:</strong> You may have the right to request a
                  copy of the personal information we hold about you. If you
                  would like a copy of some or all of your personal information,
                  please send an email to{" "}
                  <a href="mailto:contact@vicel.co.uk">this email address</a>
                </p>
                <p>
                  <strong>Amend:</strong> You may have the right to request that
                  we correct the personal information we hold about you. If you
                  would like to amend some or all of your personal information,
                  please send an email to{" "}
                  <a href="mailto:contact@vicel.co.uk">this email address</a>
                </p>
                <p>
                  <strong>Complain:</strong> You have the right to lodge a
                  complaint about the way we handle or process your personal
                  information with your local supervisory authority.
                </p>
                <p>
                  <strong>Unsubscribe:</strong> To unsubscribe from our e-mail
                  database or opt out of communications (including marketing
                  communications), please click on the unsubscribe link in the
                  e-mail that we send or send an email to{" "}
                  <a href="mailto:contact@vicel.co.uk">this email address</a>
                </p>
                ...
                <p>
                  ...
                  processing your personal information not in accordance with
                  the law you can submit a formal complaint to the Information
